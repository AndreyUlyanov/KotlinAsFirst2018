 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int) = 0.04445 * (sagenes * 48 + arshins * 16 + vershoks)
 ...
 */
fun angleInRadian(grad: Int, min: Int, sec: Int) = PI / 180 * (grad + min / 60.0 + sec / 3600.0)
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int) = initial * (percent / 100.0 + 1) * sqr(percent / 100.0 + 1)
